...
QT_MOC_LITERAL(1, 11, 11), // "searchFinsh"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "WorkThread\0searchFinsh\0"
};
...
void WorkThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkThread::searchFinsh)) {
                *result = 0;
                return;
            }
        }
